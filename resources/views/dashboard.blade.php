                ...
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="btn-group row justify-content-center">
                            ...
                            <button><a href="{{ route('requests.index') }}" class="btn btn-secondary mx-2" role="button" aria-pressed="true">Requests</a></button>
                            {{-- <button><a href="{{ route('requests_messages.index') }}" class="btn btn-secondary mx-2" role="button" aria-pressed="true">Requests Messages</a></button> --}}
